...
* **[SkySimulation](https://github.com/EzeLRA/SkySimulation)** Simulador de cielo para la prueba de brazo robótico con Arduino ; función de direccionamiento objetivo y trayectoria en tiempo real
* **[AsteroidsPython](https://github.com/EzeLRA/Asteroids_Phyton)** Recreación del juego "Asteroids" con las librerías de Python 
* **[RepositorioDeJuegos](https://github.com/EzeLRA/PrototypesGamesDev-Desactualizado-)** Conjunto de "mini proyectos" relacionados con el desarrollo de juegos estilo "retro" en C/C++
* **[EmpanadasMod](https://github.com/EzeLRA/EmpanadasMod)** Mod para minecraft , bajo la tematica de empanadas. Desarrollado en Java con la framework de Forge
* **[AzarCaracteres](https://github.com/EzeLRA/AzarDeCaracteres) Pagina web simple desarrollada con HTML-CSS-JS . Genera "claves" aleatorias

---
---

## Ejercitaciones académicas y formativos

### Logica y algoritmos
* **[EjerciciosModeloOlimpiadas](https://github.com/EzeLRA/EjerciciosEntrenamiento)** Conjunto de ejercicios modelo Olimpiadas de Programacion para entrenar
* **[EjerciciosModeloOlimpiadas](https://github.com/EzeLRA/EjerciciosPracticos)** Continuacion al repositorio de arriba
* **[AYED](https://github.com/EzeLRA/Algoritmos-y-estructuras-de-Datos)** Algoritmos y estructuras de datos - UNLP
* **[Resoluciones CADP](https://github.com/EzeLRA/finalCADP)** Resoluciones de ejercicios de la materia CADP - UNLP
* **[TallerDeProgramacion](https://github.com/EzeLRA/tallerDeProgramacion_UNLP) Resoluciones de ejercicios para la materia TDP - UNLP
* **[Rust2025](https://github.com/EzeLRA/Practicas---Seminario-Rust) Resoluciones de ejercicios para la materia Sem.Lenguajes(RUST) - UNLP
* **[Rust2026](https://github.com/EzeLRA/Practicas---Seminario-Rust-Recursada) Resoluciones de ejercicios para la materia Sem.Lenguajes(RUST) - UNLP
* **[OOP1](https://github.com/EzeLRA/OOP1) Resoluciones hechas para la mateira Orientacion a Objetos 1 - UNLP
